...
Estos originales quedan versionados fuera de `public/`, que Vite copia entero
al build y publica por URL. Los anteriores estaban allí; el logo de AgroBoeda
fue recibido directamente de Emi el 07/09. Ninguno se sirve hoy tal como está:
