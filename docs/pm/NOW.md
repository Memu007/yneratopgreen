...
- **Tarea activa:** `PROD-LISTS-1`, urgente: en el sitio publicado la marca ofrece sólo «Sin declarar» (lo vio Emi el 25/09) porque las 44 marcas las carga sólo la siembra, que no corre en producción. Migración idempotente e inventario de lo que producción necesita y sólo trae la siembra. Después, `ATRIBUTOS-RUBRO-1` parte 2.
