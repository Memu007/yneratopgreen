...
- **FILTER-INTENT-1R3 aceptada en rama:** base `0a6cbd4`/`89db3fe`, R1
  ...
  **1/1** cada uno; PM confirmó salida 0 y build incluido. El caso distingue
  interrupción real, 503, 429, refresh, arranque, sesión inválida, carrito e
  identidad. No hubo suite completa PM ni integración/despliegue de producto.
  Evidencia en
...
- **TEST-HARNESS-MAC-1 devuelta:** arnés `4b1a493`, informe `eb719c2`. La Dev
  declaró correctamente que no podía cerrar la puerta Docker. PM ejecutó el
  comando oficial en macOS y obtuvo **96/140**. Los 44 rojos quedaron reducidos
...
- **Tres auditorías UX externas preservadas:** Claude revisó navegación,
  ...
  en `docs/pm/AUDITORIAS-UX-CLAUDE-2026-08-30.md`. La tercera auditoría confirmó
  edición rota de categorías/opciones por `PATCH` contra rutas `PUT`, tablas
  administrativas truncadas a veinte filas y acciones literalmente vacías. No
