...
| 36 | **BRAND-LOSS-1 — asignada** | Integridad de datos (marca) | Las dos publicaciones de la siembra con marca la pierden a mitad de la suite en 3 de 5 corridas. Encontrar la causa; si es del producto, corregirla con su caso. Tarea activa en `PARA-DEV.md`. |
