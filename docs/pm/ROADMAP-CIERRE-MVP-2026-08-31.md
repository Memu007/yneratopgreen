...
| 35 | **ADMIN-PANEL-DEFECTS-1 — asignada** | Moderación y panel admin | P1: quien vende reactiva lo que el administrador eliminó. P2: «Agotada», estado que ve quien vende, detalle de la orden. P3: motivo de la cuenta propia. Tarea activa en `PARA-DEV.md`. |
