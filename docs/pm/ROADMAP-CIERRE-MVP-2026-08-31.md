...
| 35 | **ADMIN-PANEL-DEFECTS-1 — parte 1 verificada; parte 2 asignada** | Moderación y panel admin | Parte 1 `8f2c543`/`1ff7b87`: eliminada es definitiva para quien vende en 7 caminos (caso 190), «Agotada», detalle de la orden y motivo de la cuenta propia. PM reprodujo negativos de backend e interfaz en rojo y guía 26/26. Parte 2: el checkout rechaza lo no activo que quedó en el carrito. Evidencia en `REPRODUCCION-ADMIN-PANEL-DEFECTS-1-2026-09-24.md`. |
