...
| 12D | **DEMO-USER-1 — activa** | Pedido Emi 07/09; evaluación autenticada | Seed local idempotente crea `pruba@agroboeda.com` como usuario común verificado y sin datos previos; puede recorrer sesión y dar de alta una publicación. Caso 157; sin admin, Railway ni seed remoto. |
