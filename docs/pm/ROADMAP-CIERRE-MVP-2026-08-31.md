...
| 32 | **LOCALITY-DEDUP-1 — asignada** | Contrato 3.1 (ubicación) y devolución de la clienta #8 | 105 entidades anidadas repetidas fuera de los selectores y 49 homónimas distinguidas por departamento, sin borrar padrón ni perder `locality_id` guardados. Tarea activa única en `PARA-DEV.md`. |
