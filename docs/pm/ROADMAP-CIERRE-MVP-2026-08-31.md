...
| 12B | **MARKET-VIEWS-1 — activa** | Feedback visual Emi 06/09; handoff grilla/lista | Dev implementa selector explícito Cuadrícula/Lista, geometría uniforme por modo y ningún activo de fila completa. Ordenar no cambia vista. Caso 155. |
| 12C | **BRAND-AGROBOEDA-1 — en cola inmediata** | Decisión Emi 07/09; fuente oficial AB | Sustituir TopGreen/BOEDA visibles por AgroBoeda, integrar derivados fieles del PNG oficial y conservar nombres técnicos internos. No se mezcla con Mercado ni despliega por sí sola. |
