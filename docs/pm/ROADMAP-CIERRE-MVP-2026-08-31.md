...
| 12 | **TRANSFER-REVIEW-1R — cerrada** | F8 | Aceptada en `0878bd4`/`5f82093` + `b9eddf3`/`ee42e62`/`317379c`: capa propia, motivo y error quedan coherentes; PM reprodujo 153 corregido en 1/1 y verificó que las cuatro salidas no mienten durante el PATCH. |
| 12A | **REGISTER-POLISH-1R — cerrada** | Feedback visual Emi 06/09 | Aceptada en `7ca4fc7`/`dd84ee0` + `7268958`/`64aaf6c`: alta alineada y profesional, control de contraseña integrado, expansión clara y caso 154 limpio; PM reprodujo 154 final en 1/1. |
| 12B | **MARKET-VIEWS-1 — cerrada** | Feedback visual Emi 06/09; handoff grilla/lista | Aceptada en `b5ee28d`/`afbfb95`/`931a063`: dos vistas accesibles, geometría uniforme y caso 155 reproducido por PM. Suite PM 154/155 + 122 aislado verde; no se declara 155/155. |
| 12C | **BRAND-AGROBOEDA-1R — cerrada** | Base `f0913a7`/`c61b8b9`; corrección `21526bb`/`879d79f`; merge `1286ed2` | Identidad AgroBoeda y marca de Header/Footer conformes. PM obtuvo 147+156 en 2/2 y verificó integración exacta en `main`; sin suite completa adicional. |
...
Las piezas 12A/12B responden a una decisión visual explícita de Emi y recuperan
el requisito de grilla/lista del handoff. No reabren la identidad, las cuatro
anatomías ni el detalle. Su contrato completo y la evidencia de raíz están en
...
| 25 | **ADMIN-MOBILE-ACCESS-1 — aceptada en rama** | Responsive y usabilidad final | Producto/caso 182/sabotajes `b2a3ba4`, informe `a11b52a`. PM reprodujo 14/14 casos relacionados, un sabotaje rojo del desplazamiento horizontal y el focal restaurado 1/1. Evidencia en `REPRODUCCION-ADMIN-MOBILE-ACCESS-1-2026-09-23.md`. Sin integración ni despliegue. |
...
| 30 | **PRODUCT-DETAIL-BACK-SEARCH-1 — aceptada en rama** | Navegación de ficha | Producto/caso 186/negativo `ce0380e`, informe `2c300bf`. Dev corrigió su medición: era un cuadro sin `q`, no una pérdida. PM: 186 en 1/1 (10 vueltas, 1.493 cuadros), negativo rojo 10/10, 147/148/183/185 en 4/4, build/lint/tipos verdes. Evidencia en `REPRODUCCION-PRODUCT-DETAIL-BACK-SEARCH-1-2026-09-23.md`; sin integración ni despliegue. |
| 31 | **FILTER-COLLAPSE-FOCUS-1 — aceptada en rama** | Accesibilidad móvil | Producto/caso 187/negativos/marcador a11y `4fa8809`, informe `0fd3217`. PM: 187 en 1/1, tres negativos rojos, 7/7 relacionados, a11y 76/76, contraste 84/84, auditoría móvil 12/12. «Ver N resultados» vuelve al principio con «Filtros» visible (decisión PM). Evidencia en `REPRODUCCION-FILTER-COLLAPSE-FOCUS-1-2026-09-24.md`; sin integración ni despliegue. |
| 32 | **LOCALITY-DEDUP-1 — aceptada en rama** | Contrato 3.1 (ubicación) y devolución de la clienta #8 | Producto/caso 188/negativos `34bab15`, informe `fc246c0`. PM: SQL independiente 105 anidadas y 51 homónimas; 188 en 1/1, cuatro negativos rojos, 45/45 relacionados, a11y 76/76, contraste 84/84, auditoría 12/12. Evidencia en `REPRODUCCION-LOCALITY-DEDUP-1-2026-09-24.md`; sin integración ni despliegue. |
| 33 | **LOCALITY-LABEL-DISPLAY-1 — aceptada en rama** | Contrato 3.1 (ubicación visible) | Producto/caso 189/negativos `0830ac2`, informe `8e64f82`. PM: 189 en 1/1, cuatro negativos rojos, 62/62 relacionados, a11y 76/76, contraste 84/84, auditoría 12/12; 137 ajustado sin debilitar privacidad. Evidencia en `REPRODUCCION-LOCALITY-LABEL-DISPLAY-1-2026-09-24.md`. |
| 34 | **ADMIN-GUIDE-1 — aceptada en rama** | Contrato: capacitación básica del panel admin | Guía `81f40dd` devuelta una vez: las frases de resultado no estaban atadas. Corrección `091e846`, informe `d0aff46`. PM: 26/26 en los dos anchos; tres afirmaciones falsas y un negativo nuevo en rojo; siete negativos de Dev en rojo. Evidencia en `REPRODUCCION-ADMIN-GUIDE-1-2026-09-24.md`. |
| 35 | **ADMIN-PANEL-DEFECTS-1 — aceptada en rama** | Moderación y panel admin | Parte 1 `8f2c543`/`1ff7b87`: eliminada es definitiva para quien vende (caso 190), «Agotada», detalle de la orden y cuenta propia. Parte 2 `7ed5099`/`10f1bd6`: el checkout rechaza lo no activo (caso 191). PM: negativos en rojo, guía 26/26, suite 190/191 cubiertos (169 de entorno). Evidencia en `REPRODUCCION-ADMIN-PANEL-DEFECTS-1-2026-09-24.md`. |
...
| 38 | **MERCADO-UNICO-1 — aceptada en rama** | Devolución de la clienta #7 (Emi, 25/09) | `29ea2ec`/`2b71709`: sin pestaña Servicios; enlaces viejos al Mercado filtrado. PM: 193 en 1/1, cinco negativos en rojo, suite 191/193, puertas verdes. Evidencia en `REPRODUCCION-MERCADO-UNICO-1-2026-09-25.md`. |
| 39 | **ATRIBUTOS-RUBRO-1 — aceptada en rama (dos partes)** | Devolución de la clienta #9, absorbida (Emi, 25/09) | Parte 1 publicada en `792d709` (tipo y potencia; `REPRODUCCION-ATRIBUTOS-RUBRO-1-P1-2026-09-25.md`). Parte 2 `8a72310`/`85650e8`/`cd75cdf`, integrada en `2a00720`: modelo, año, origen declarado, tres P2 y panel en tres grupos con «Más filtros». PM: 6/6, ocho negativos en rojo, suite 203/204, migración en modo producción. Evidencia en `REPRODUCCION-ATRIBUTOS-RUBRO-1-P2-2026-09-26.md`. |
| 39P | **PROD-LISTS-1 — aceptada en rama** | Defecto visto por Emi en el sitio publicado (25/09) | La marca ofrecía sólo «Sin declarar»: la lista la cargaba sólo la siembra. Migración `01ff14043124` (44 marcas y 4028 localidades, idempotente) y filtro de marca completo con Maquinaria (decisión de Emi). `2b2a0c3`…`7f045a6`, informe `cdda2d9`. PM: 3/3, seis negativos en rojo, migración en modo producción, suite 197/198. Evidencia en `REPRODUCCION-PROD-LISTS-1-2026-09-26.md`. |
| 40 | **USER-GUIDE-1 — asignada** | Documentación de uso; el manual actual tiene la marca vieja y credenciales demo | Reescribir `docs/USER_MANUAL.md` para quien compra, vende y transporta, verificada por programa como la guía del panel. Suma el caso del modelo en el buscador. Tarea activa en `PARA-DEV.md`. |
