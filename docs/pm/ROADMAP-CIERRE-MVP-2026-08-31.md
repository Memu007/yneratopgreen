...
| 12C | **BRAND-AGROBOEDA-1R — corrección activa** | Decisión Emi 07/09; entrega `f0913a7`/`c61b8b9` | Migración visual/emitida conforme; falta que la marca del Footer sea un control accesible a Inicio y que 156 lo pruebe específicamente. Corrección focal, sin suite completa ni despliegue. |
