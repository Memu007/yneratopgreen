...
| 12D | **DEMO-USER-1R — corrección activa** | Entrega `53a9635`/`bf31919`; PM 157 en 1/1 | Cuenta, login, publicación, doble seed y salidas locales conformes. Falta alinear DATABASE/USER_MANUAL/README y hacer que 157 controle esas listas; sin suite completa adicional. |
