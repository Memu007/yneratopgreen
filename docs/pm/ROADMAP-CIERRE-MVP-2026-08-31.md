...
| 33 | **LOCALITY-LABEL-DISPLAY-1 — asignada** | Contrato 3.1 (ubicación visible) | Tarjeta, ficha y base del transportista muestran el departamento de las homónimas. Tarea activa única en `PARA-DEV.md`. |
