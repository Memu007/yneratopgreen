...
| 34 | **ADMIN-GUIDE-1 — asignada** | Contrato: capacitación básica del panel admin | Guía para la clienta verificada por script contra el panel real; reemplaza la sección admin desactualizada de `USER_MANUAL.md`. Tarea activa única en `PARA-DEV.md`. |
