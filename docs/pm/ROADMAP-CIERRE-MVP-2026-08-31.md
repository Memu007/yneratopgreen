...
| 39 | **ATRIBUTOS-RUBRO-1 — asignada (dos partes)** | Devolución de la clienta #9, absorbida (Emi, 25/09) | Parte 1: tipo (tercer nivel) en los 7 rubros y potencia de tractores. Parte 2: modelo y año en maquinaria, y origen declarado. Tarea activa en `PARA-DEV.md`. |
