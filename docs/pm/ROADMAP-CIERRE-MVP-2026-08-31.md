...
| 28 | **MOBILE-CHECKOUT-1 — asignada** | Compra móvil del MVP | Actualizar el recorrido para elegir traslado y reproducir/corregir contenido de envío recortado a 360/390 px. Una sola tarea activa en `PARA-DEV.md`; sin integración ni despliegue. |
| 29 | **FICHA-MOBILE-WIDTH-1 — en cola** | Ficha móvil | PM midió 368 px de contenido en pantalla de 360 con «Campo Agrícola de 120 Hectáreas». Resolver después del checkout. |
| 30 | **FILTER-COLLAPSE-FOCUS-1 — en cola** | Accesibilidad móvil | PM confirmó que Tab entra en controles de filtros invisibles con el panel cerrado a 390 px. Resolver después del checkout. |
