...
| 23 | **CART-IMG-QUERY-1 — activa** | N+1 registrado en `cart.py` | Medir uno frente a varios ítems, acotar por petición las lecturas de `product_images`, conservar contrato y agregar caso 180 con negativo discriminante. Sin deploy. |
