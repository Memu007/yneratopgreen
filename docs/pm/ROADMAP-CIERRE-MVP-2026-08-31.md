...
| 12C | **BRAND-AGROBOEDA-1R — integración activa** | Base `f0913a7`/`c61b8b9`; corrección `21526bb`/`879d79f` en rama Dev | Corrección técnicamente conforme: PM obtuvo 147+156 en 2/2 y puertas focales verdes. Falta integrar los dos commits sin cambios a `main`; no repetir pruebas. |
| 12D | **DEMO-USER-1 — en cola** | Pedido Emi 07/09; evaluación autenticada | Seed local idempotente crea `pruba@agroboeda.com` como usuario común verificado y sin datos previos; puede recorrer sesión y dar de alta una publicación. Sin admin, Railway ni seed remoto. |
| 12E | **FOOTER-FOCUS-1 — deuda en cola** | Hallazgo Dev/PM durante 1R | Los enlaces textuales del Footer tienen foco 1,0:1 contra el fondo. Corregir color y medir controles reales después de DEMO-USER-1; no bloquea marca ni cuenta demo. |
