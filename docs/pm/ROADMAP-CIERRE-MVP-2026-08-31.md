...
| 26 | **PRODUCT-DETAIL-PAGE-1 — asignada** | Ajuste de usabilidad pedido por Emi el 23/09 | Reemplazar el modal de detalle por página con URL propia, acceso directo y recarga; Atrás vuelve al catálogo conservando su estado. Sin copiar otro sitio ni añadir funciones comerciales. Tarea activa en `PARA-DEV.md`. |
