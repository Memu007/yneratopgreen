...
| 38 | **USER-GUIDE-1 — asignada** | Contrato: capacitación y documentación de uso | Guía de comprador, vendedor y transportista verificada por script contra la aplicación. Tarea activa en `PARA-DEV.md`. |
