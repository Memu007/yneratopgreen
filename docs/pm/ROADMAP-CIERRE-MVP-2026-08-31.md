...
| 31 | **FILTER-COLLAPSE-FOCUS-1 — asignada** | Accesibilidad móvil | PM reprodujo sobre `ce0380e` a 390 px: con «Filtros» cerrado, Tab recorre 11 controles invisibles antes de «Ordenar». Tarea activa única en `PARA-DEV.md`. |
