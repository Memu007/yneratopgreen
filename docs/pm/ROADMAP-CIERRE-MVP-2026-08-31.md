...
| 39 | **ATRIBUTOS-RUBRO-1 — parte 1 aceptada en rama; parte 2 asignada** | Devolución de la clienta #9, absorbida (Emi, 25/09) | Parte 1 `e624831`…`7177b2d`, informe `ba18f76`, integrada en `d283cac`: tipo en 33 subrubros (122 opciones) y potencia de Tractores; las listas llegan a producción con la migración `c8e41f2a7d90`. PM: 4/4 focales, seis negativos en rojo, suite 195/196 (169 de entorno), a11y 78/78, contraste 86/86, móvil 12/12, guía 26. Evidencia en `REPRODUCCION-ATRIBUTOS-RUBRO-1-P1-2026-09-25.md`. Parte 2: modelo, año, origen declarado y dos P2; tarea activa en `PARA-DEV.md`. |
