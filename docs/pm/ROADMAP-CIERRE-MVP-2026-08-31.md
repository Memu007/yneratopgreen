...
| 27 | **MOBILE-AUDIT-FLOW-1 — asignada** | QA responsive del MVP | El script móvil debe abrir el panel plegable antes de usar sus filtros y llegar al detalle sin sobrescribir capturas históricas. PM ejecuta la puerta Docker y clasifica cualquier hallazgo real. |
