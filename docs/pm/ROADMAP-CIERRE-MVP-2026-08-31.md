...
| 12E | **FOOTER-FOCUS-1 — activa** | Hallazgo Dev/PM durante BRAND-1R | Los enlaces textuales del Footer tienen foco 1,0:1 contra el fondo. Reutilizar el color visible de la marca y medir todos los controles reales en caso 158; sin suite completa. |
| 12F | **LOGO-INTEGRATION-1 — siguiente inmediata** | Feedback visual Emi 08/09 | Retirar la placa opaca del monograma con un derivado RGBA fiel, transparente y sin halo para Header/Footer. Mantener glifo, texto, geometría y favicon; seis capturas, sin rediseño ni generación. |
