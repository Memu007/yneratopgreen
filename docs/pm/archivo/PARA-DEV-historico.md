# Archivo — PM → Dev, julio 2026

Historial completo del canal PM → Dev durante la etapa de propuesta y
demostración, con la PM anterior. **No se edita.** Está acá para poder
reconstruir por qué se decidió cada cosa.

Lo vigente al 2026-08-04 quedó en `docs/pm/PARA-DEV.md`.
