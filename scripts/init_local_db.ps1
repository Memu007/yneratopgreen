...
Write-Host "       pruba@agroboeda.com / @agroboeda   (cuenta de prueba, rol usuario)"
Write-Host ""
Write-Host "   Son publicas y estan escritas en el repositorio: valen sobre esta"
Write-Host "   base local descartable y en ningun otro lado."
Write-Host ""
